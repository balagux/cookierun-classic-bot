...
4. กด Pause แล้วกด Quit
5. รอจนตรวจพบ Main Menu จึงนับว่าจบรอบ
6. เริ่มรอบถัดไปทันทีโดยไม่สุ่มรอ 3–7 วินาที

โหมดนี้ไม่ทำงานระหว่าง **อัดโปรไฟล์** เพื่อไม่ให้บอทตัดการอัดเอง และรอบที่ออกก่อนหน้า Result
จะไม่มี Coins/EXP ใหม่จาก OCR มารวมในสถิติ
