...
DEVICE_PORT = 5556        # Change to your adb device's port number
...
STAGE_MYSTERY_BOX_TEMPLATE = ["MYSTERY_BOX_1.png", "MYSTERY_BOX_OPEN_1.png"]
...
# Classic clients use both "Mystery Box" and "Open a Mystery Box" banners.
# Keep one bounded title region large enough for either wording.
STAGE_MYSTERY_BOX_REGION = (380, 25, 900, 125)
...
# The template is 580x326.  The old 578x322 crop made OpenCV skip this
# stage entirely because the search area was smaller than the template.
STAGE_TOO_MANY_TREASURES_REGION = (345, 145, 940, 485)
...
GLOBAL_CONFIRM_TEMPLATE = CONFIRM_SEND_LIFE_TEMPLATE
COOKIE_RELAY_ZERO_TEMPLATE = ["COOKIE_RELAY_ZERO_1.png"]

# -------------------
# DETECTION REGION
# -------------------
RANDOM_BOOST_REGION = (701, 505, 1091, 578)
FRIEND_TOP_LEADERBOARD_REGION = (125, 245, 230, 610)
FRIEND_BOTTOM_LEADERBOARD_REGION = (235, 515, 675, 675)
FRIEND_SEND_LIFE_REGION = (570, 240, 760, 665)
FRIEND_ACKNOWLEDGEMENT_REGION = (360, 330, 900, 570)
NO_LIVES_TO_RECEIVE_REGION = (454, 223, 824, 575)
ALL_LIVES_RECEIVED_AND_SENT_REGION = (396, 267, 882, 346)
CONFIRM_SEND_LIFE_REGION = (585, 360, 1000, 560)
COOKIE_RELAY_ZERO_REGION = (315, 620, 455, 680)
# Top-right quantity badge on the Cookie Relay shop tile.  When stock is
# zero the white quantity digit is absent and the grey empty badge is shown.
COOKIE_RELAY_STOCK_REGION = (418, 532, 452, 570)
...
RANDOM_BOOST_DIALOG_CLOSE_BUTTON = (1040, 80)
RANDOM_BOOST_SELECTION_BUTTONS = {
    "Double Coins": (284, 175),
    "+15% Score Bonus": (666, 175),
    "-15% HP Drain": (284, 225),
    "Revive Once with 80 HP": (666, 225),
    "70% Crush Chance": (284, 275),
    "+17% Base Speed": (666, 275),
    "Gold Coin Magic": (284, 325),
    "-30% Collision Damage": (666, 325),
    "+20% HP from Potions": (284, 375),
    "Magnetic Aura": (666, 375),
    "2 Pit Lifts": (284, 425),
}
FAST_START_USE_BUTTON = (655, 340)
COOKIE_RELAY_USE_BUTTON = (655, 340)
PAUSE_GAME_BUTTON = (1195, 35)
QUIT_GAME_BUTTON = (630, 425)
CONFIRM_QUIT_BUTTON = (630, 365)
PAUSE_QUIT_BUTTON_REGION = (460, 360, 800, 490)
CONFIRM_QUIT_BUTTON_REGION = (460, 300, 800, 430)
QUIT_BUTTON_WAIT_TIMEOUT = 2.0
QUIT_BUTTON_COLOR_RATIO = 0.5
